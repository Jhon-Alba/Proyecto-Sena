...
def activar_administrador(request, pk):
    ...
    administrador.save()
    messages.success(request, '¡Administrador activado con éxito!')
    return redirect('administrador_lista')  
...
def desactivar_administrador(request, pk):
    ...
    administrador.save()
    messages.success(request, '¡Administrador desactivado con éxito!')
    return redirect('administrador_lista')
...
def reporte_administradores_excel(request):
    ...
    headers = ["ID", "Nombre", "Email", "Tipo de Documento", "Número de Documento", "Teléfono"]
    ws.append(headers)
