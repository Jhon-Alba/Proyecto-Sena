...
urlpatterns = [
    ...
    ### CRUD Empleado ###
      path('empleado/', views.empleado_list, name='empleado_lista'),
    path('empleado/reporte/excel/', views.reporte_empleados_excel, name='reporte_empleados_excel'),
    path('empleado/reporte/pdf/', views.reporte_empleados_pdf, name='reporte_empleados_pdf'),
    
    ### CRUD Empleado ###
    path('listar/', views.empleado_list, name='empleado_lista'),
