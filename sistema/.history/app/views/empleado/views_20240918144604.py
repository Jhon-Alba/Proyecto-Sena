...
def empleado_list(request):
    if not request.user.has_perm('app.view_empleado'):
        return render(request, 'empleado/index.html', {'has_permission': False})

    empleados = Empleado.objects.all()

    breadcrumbs = [
        {'name': 'Inicio', 'url': '/dashboard'},
        {'name': 'Empleados', 'url': '/app/empleado/'},
    ]
...
def empleado_create(request):
    ...
    breadcrumbs = [
        {'name': 'Inicio', 'url': '/dashboard'},
        {'name': 'Empleados', 'url': '/app/empleado/'},
        {'name': 'Registrar Empleado', 'url': '/app/crear/'},
    ]
...
def empleado_update(request, pk):
    ...
    breadcrumbs = [
        {'name': 'Inicio', 'url': '/dashboard'},
        {'name': 'Empleados', 'url': '/app/empleado/'},
        {'name': 'Editar Empleado', 'url': f'/app/empleado/editar/{pk}/'},
    ]
