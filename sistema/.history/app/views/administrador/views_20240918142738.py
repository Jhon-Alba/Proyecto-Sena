...
def administrador_lista(request):
    ...
    if estado_filtro == 'activado':
        administradores = administradores.filter(activado=True)
    elif estado_filtro == 'inactivado':
        administradores = administradores.filter(activado=False)

    if buscar_nombre:
        administradores = administradores.filter(nombre__icontains=buscar_nombre)

    if buscar_telefono:
        administradores = administradores.filter(telefono__icontains=buscar_telefono)
